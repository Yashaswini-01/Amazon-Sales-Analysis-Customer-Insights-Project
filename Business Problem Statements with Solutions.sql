...
-- View the different types of payment status available 
SELECT DISTINCT payment_status 
FROM payments;

-- Check the orders which are returned and the return date is NULL and NOT NULL
SELECT * FROM shippings 
...
-- Check the status of the order id 6747
SELECT * FROM orders 
WHERE order_id = 6747;

-- Check the payment table which are returned and got the amount refunded
SELECT * FROM payments
WHERE order_id = 6747;

-------------------------------------------------------------------------------
-- Advanced Analysis - Business Problems 
/* 
1. Top Selling Products
Query the top 10 products by total sales revenue.
